...
public class PrppCustomer extends EntitySupport<PrppCustomerId> {

	private PrppCustomerId id;
	...
	public PrppCustomer(PrppCustomerId id, String policyno, String riskcode) {
		this.id = id;
		this.policyno = policyno;
		this.riskcode = riskcode;
	}

	public PrppCustomer(PrppCustomerId id, String policyno, String riskcode, String language, String insuredtype,
			...
			String payeename, String payeeidentifynumber, String refundreason, String receiver, String branchaccount,
			String industry) {
		this.id = id;
		this.policyno = policyno;
		this.riskcode = riskcode;
	...
	public PrppCustomerId getId() {
		return this.id;
	}

	public void setId(PrppCustomerId id) {
		this.id = id;
	}
