...
<table class="form" id="FileCoreQuery.query">
	<tbody>
		...
		<tr>
			...
			<td>
			 	<input name="visaCode" id="visaCode" class="text" />
			</td>
			<td class="title">
		...
		<tr>
			<td class="title"><s:text name="file.document.salesman" />：</td>
			<td><input name="sales" id="sales" class="text" /></td>
			<td class="title"><s:text name="file.document.status" />：</td>
			<td colspan="2"><s:checkboxlist name="documentStatus" id="documentStatus" cssClass="checkbox" list="#request.documentStatus" /></td>
		</tr>
		<tr>
