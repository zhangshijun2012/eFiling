...
import com.sinosoft.efiling.service.ProductService;
...
public class SystemUtils {
	/** 菜单、权限等表中的systemCode */
	public static final String SYSTEM_CODE = SystemHelper.getProperty("system.code", "eFiling");
	/** 系统正式上线的时间2014-04-29 */
	public static final Date SYSTEM_GO_LIVE_TIME = DateHelper.parse(SystemHelper.getProperty("system.goLiveTime", "2014-04-27"));
	/** 系统使用的编码 */
	public static final String ENCODING = SystemHelper.getProperty("system.encoding", SystemHelper.ENCODING_UTF_8);
	...
	/** 关于组织机构的资料类型代码 */
	public static final String[] FILE_TYPE_UNIT_CODES = { "251" };// FILE_TYPE_LICENSE_BUSINESS, FILE_TYPE_LICENSE_TAX };

	/** 204.行驶证 */
	public static final String FILE_TYPE_VEHICLE_LICENSE = "204";
	/** 202--车辆合格证或购车发票 */
	public static final String FILE_TYPE_VEHICLE_INVOICE = "202";
	/** 258--货物进出口证明书/购车发票（进口) */
	public static final String FILE_TYPE_VEHICLE_IMPORT = "258";
	/** 281--投保人实际控制人或法定代理人或负责人身份证件*/
	public static final String FILE_TYPE_AGENT_APPLICANT = "281";
	/** 282--被保险人实际控制人或法定代理人或负责人身份证件*/
	public static final String FILE_TYPE_AGENT_INSURED = "282";


	/** 202,204,258,行驶证相关资料类型,prpDCode表的codecode */
	public static final String[] FILE_TYPE_VEHICLE_CODES = { FILE_TYPE_VEHICLE_LICENSE, FILE_TYPE_VEHICLE_INVOICE,
			FILE_TYPE_VEHICLE_IMPORT };
	...
	// public static final String[] FILE_TYPE_INSURED_CODES = { FILE_TYPE_INSURED, FILE_TYPE_LICENSE_BUSINESS,
	// FILE_TYPE_LICENSE_TAX };
	/** 201.投保人相关资料类型,prpDCode表的codecode,应该包括税务登记证和营业执照 */
	public static final String[] FILE_TYPE_APPLICANT_CODES = { FILE_TYPE_APPLICANT };
	/** 200.被保人相关资料类型,prpDCode表的codecode */
	public static final String[] FILE_TYPE_INSURED_CODES = { FILE_TYPE_INSURED };
	/** 281.投保人实际控制人或法定代理人或负责人身份证件 */
	public static final String[] FILE_TYPE_AGENT_APPLICANT_CODES = { FILE_TYPE_AGENT_APPLICANT };
	/** 282.被保险人实际控制人或法定代理人或负责人身份证件*/
	public static final String[] FILE_TYPE_AGENT_INSURED_CODES = { FILE_TYPE_AGENT_INSURED };
	/** 251,280.均为车主的资料,251.税务登记证/营业执照（三证合一）复印件, 280.纳税人身份证 */
	public static final String[] FILE_TYPE_CAR_OWNER_CODES = { "251", "280" };
	/**
	 * 身份证/组织机构代码证资料类型,prpDCode表的codecode. 此类型的资料可以互相共享
	 * 包括FILE_TYPE_APPLICANT_CODES,FILE_TYPE_INSURED_CODES,FILE_TYPE_CAR_OWNER_CODES
	 * FILE_TYPE_AGENT_APPLICANT_CODES,FILE_TYPE_AGENT_INSURED_CODES
	 * 
	 * @see #FILE_TYPE_APPLICANT_CODES
	 * @see #FILE_TYPE_INSURED_CODES
	 * @see #FILE_TYPE_CAR_OWNER_CODES
	 * @see #FILE_TYPE_AGENT_APPLICANT_CODES
	 * @see #FILE_TYPE_AGENT_INSURED_CODES
	 */
	public static final String[] FILE_TYPE_CLIENT_CODES = new String[FILE_TYPE_APPLICANT_CODES.length + FILE_TYPE_INSURED_CODES.length
			+ FILE_TYPE_CAR_OWNER_CODES.length + FILE_TYPE_AGENT_APPLICANT_CODES.length + FILE_TYPE_AGENT_INSURED_CODES.length];
	static {
		...
		System.arraycopy(FILE_TYPE_CAR_OWNER_CODES, 0, FILE_TYPE_CLIENT_CODES, FILE_TYPE_APPLICANT_CODES.length + FILE_TYPE_INSURED_CODES.length,
				FILE_TYPE_CAR_OWNER_CODES.length);
		System.arraycopy(FILE_TYPE_AGENT_APPLICANT_CODES, 0, FILE_TYPE_CLIENT_CODES, FILE_TYPE_APPLICANT_CODES.length + FILE_TYPE_INSURED_CODES.length + FILE_TYPE_CAR_OWNER_CODES.length,
				FILE_TYPE_AGENT_APPLICANT_CODES.length);
		System.arraycopy(FILE_TYPE_AGENT_INSURED_CODES, 0, FILE_TYPE_CLIENT_CODES, FILE_TYPE_APPLICANT_CODES.length + FILE_TYPE_INSURED_CODES.length + FILE_TYPE_CAR_OWNER_CODES.length + FILE_TYPE_AGENT_APPLICANT_CODES.length,
				FILE_TYPE_AGENT_INSURED_CODES.length);
	}
	public static void main(String[] args) {
		//System.out.println(FILE_TYPE_CLIENT_CODES);
		System.out.println(FILE_TYPE_APPLICANT_CODES.length);
		System.arraycopy(FILE_TYPE_APPLICANT_CODES, 0, FILE_TYPE_CLIENT_CODES, 0, FILE_TYPE_APPLICANT_CODES.length);
	...
	/** 已使用单证:资料类型为已使用单证:的投保人字段保存的数据 */
	public static final String APPLICANT_VISA_USERD = "保单留存联";
	...
	/** 004.资料类型为保单留存联*/
	public static final String FILE_TYPE_VISA_USED = "004";
	...
	static {
		...
		//VISA_STATUS.put(FILE_TYPE_VISA_LOST, "file.type.visa.used");
	}
	...
	/**1:纸质档案手工归档*/
	public static final String DOCUMENT_PAPER_STATUS_1 = "1";
	...
	/** 9.审核通过 */
	public static final String FILE_APPROVE_STATUS_AUDITED = "9";
	/** 2.审核不通过 */
	...
	// /** N.禁用,审核不通过的上传资料 */
	// public static final String DOCUMENT_FILE_STATUS_REJECTED = "N";
	/** 归档状态及对应的描述 */
	...
	static {
		...
		//DOCUMENT_FILE_STATUS.put(DOCUMENT_FILE_STATUS_CANCEL, "file.document.status.20");
		...
		// DOCUMENT_FILE_STATUS.put(DOCUMENT_FILE_STATUS_REJECTED, "file.status.N");
	}
	...
	/** 车险险类05 */
	public static final String RISK_CLASS_MOTOR = "05";
	/**
	 * 车险险类05
	 * 
	 * @See {@link #RISK_CLASS_MOTOR }
	 */
	@Deprecated
	...
	public static void initialize() {
		...
		List<Product> products = (List<Product>) productService.query("FROM " + Product.class.getName());
	...
	/** 是否可查看禁用文件的session名 */
	public static final String VIEW_DISABLED_FILE_SESSION_NAME = "viewDisabledFile";
	...
	//手动归档原因
	public static final String FILE_MANUAL_MESSAGE = "跨年投保已完税完税凭证号为空";
	/** 自动单证审核 */
	...
	/** 407.禁用文件查看岗 */
	public static final String GRADE_CODE_VIEW_DISABLED_FILE = "407";

	/** 04表示有效单证 */
	public static final String VISA_STATUS_VALID = "04";
	/** 05遗失 */
	public static final String VISA_STATUS_LOST = "05";
	/** 06作废单证 */
	public static final String VISA_STATUS_VOIDED = "06";
	...
	public static final String[] SESSION_NAMES = { USER_SESSION_NAME, DEPARTMENT_SESSION_NAME, COMPANY_SESSION_NAME,
			VIEW_DISABLED_FILE_SESSION_NAME, "UserCode", "ComCode", "CenterCode" };
	...
	public static void initializeUserSession(HttpSession session, UserSessionEntity user) {
		...
		session.setAttribute(VIEW_DISABLED_FILE_SESSION_NAME, false); // 当前登录人员
		if (user.getCurrentGrades() != null) {
			for (Grade grade : user.getCurrentGrades()) {
				if (SystemUtils.GRADE_CODE_VIEW_DISABLED_FILE.equalsIgnoreCase(grade.getId())) {
					// 可查看禁用文件的岗位
					session.setAttribute(VIEW_DISABLED_FILE_SESSION_NAME, true);
					break;
				}
			}
		}
	...
	public static void setServerHome(ServletContext context) {
		if (!StringHelper.isEmpty(SERVER_HOME)) { return; }
