...
/**
 * Prptcarshiptax generated by hbm2java
 */
public class Prptcarshiptax extends EntitySupport<String> implements java.io.Serializable {
	...
	public Prptcarshiptax() {
	}

	public Prptcarshiptax(String proposalno, long serialno, String riskcode) {
	...
	@Id
	@Column(name = "PROPOSALNO", unique = true, nullable = false, length = 22)
