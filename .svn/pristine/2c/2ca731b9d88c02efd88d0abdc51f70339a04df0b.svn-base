...
<table class="form" id="FileImage.save">
	<tr class="nowrap">
		<td width="5%" class="title" style="padding-left: 3px"><s:text name="file.document.no" /></td>
		<td width="45%"><input name="no" class="text" onblur="this.value = this.value.trim();" /></td>
	...
	<!-- <tr>
		<td colspan="4" style="height: 10000px; padding-left: 3px" id="uploaderContainer"></td>
	</tr> -->
</table>
</div>
