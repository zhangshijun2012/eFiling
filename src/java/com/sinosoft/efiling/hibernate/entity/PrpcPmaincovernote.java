...
public class PrpcPmaincovernote extends EntitySupport<String> {
	...
	public PrpcPmaincovernote() {
	}

	public PrpcPmaincovernote(String id, String classcode, String riskcode, String policysort, String businessnature,
			String makecom, String comcode, String handlercode, String operatorcode) {
		this.id = id;
	...
	public PrpcPmaincovernote(String id, String classcode, String riskcode, String proposalno, String contractno,
			String policysort, String printno, String businessnature, String language, String policytype,
			String applicode, String appliname, String appliaddress, String insuredcode, String insuredname,
			String insuredaddress, Date operatedate, Date startdate, Double starthour, Date enddate, Double endhour,
			Double purerate, Double disrate, Double discount, String currency, Double sumvalue, Double sumamount,
			Double sumdiscount, Double sumpremium, Double sumsubprem, Double sumquantity, String judicalcode,
			String judicalscope, String autotransrenewflag, String arguesolution, String arbitboardname,
			Double paytimes, Double endorsetimes, Double claimtimes, String makecom, String operatesite,
			String comcode, String handlercode, String handler1code, String approvercode, String underwritecode,
			String underwritename, String operatorcode, Date inputdate, Double inputhour, Date underwriteenddate,
			Date statisticsym, String agentcode, String coinsflag, String reinsflag, String allinsflag,
			String underwriteflag, String othflag, String flag, Double disrate1, String businessflag,
