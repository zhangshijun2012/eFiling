...
/**
 * PrpTItemcar generated by hbm2java
 */
@SuppressWarnings("serial")
public class PrpTItemcar extends EntitySupport<PrpTItemcarId> {

	private PrpTItemcarId id;
	...
	public PrpTItemcar(PrpTItemcarId id, String riskCode) {
		this.id = id;
		this.riskCode = riskCode;
	}

	public PrpTItemcarId getId() {
		return id;
	}

	public void setId(PrpTItemcarId id) {
		this.id = id;
	}
